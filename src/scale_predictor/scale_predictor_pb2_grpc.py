...
import src.scale_predictor.scale_predictor_pb2 as scale__predictor__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in scale_predictor_pb2_grpc.py depends on'
...
def add_ScalePredictorServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('scale_predictor.ScalePredictor', rpc_method_handlers)
